...
namespace QIF_Model.QIFLibrary.Features.FeatureMeasurement
{
    ...
    public abstract class FeatureMeasurementBaseType : FeatureBaseType
    {
        ...
        /// associated feature item(which will reference feature nominal information).</remarks>
        [XmlElement()]
        ...
        /// then the feature name will be that defined by the referenced feature item.</remarks>
        [XmlElement()]
        public string FeatureName { get; set; }

        /// <remarks> The optional TimeStamp element is the date and time at which
        /// the feature was measured.</remarks>
        [XmlElement]
        ...
        /// actual component to which this feature actual belongs.</remarks>
        [XmlElement()]
        ...
        /// to the traceability information for the process used to manufacture this feature.</remarks>
        [XmlElement()]
        ...
        /// references to the measurement devices used in the inspection of the feature.</remarks>
        [XmlElement()]
        ...
        /// the common coordinate system and the actual coordinate system or actual DRF.</remarks>
        [XmlElement()]
        ...
        /// noted events that happened during the measurement of this feature.</remarks>
        [XmlElement()]
    ...
    /// feature size and feature location.</remarks>
    public abstract class ShapeFeatureMeasurementBaseType : FeatureMeasurementBaseType
    {
        ...
        /// measured points for the feature.</remarks>
        [XmlElement()]
        ...
        /// measurement points were taken to establish a plane.</remarks>
        [XmlElement()]
        public Primitives.QIFReferenceType ProxyMeasurementId { get; set; }
    }

    /// <remarks> The OtherShapeFeatureMeasurementType defines the other shape feature measurement information for an individual other shape feature.</remarks>
    ...
    /// <remarks> The CurveFeatureMeasurementBaseType is the abstract base type for shape feature measurements for features composed of curves.</remarks>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    [System.SerializableAttribute()]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    ...
    /// measurement information for an individual other curve feature.</remarks>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    [System.SerializableAttribute()]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
