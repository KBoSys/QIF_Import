...
namespace QIF_Model.QIFLibrary.Characteristics.Measurement
{
    ...
    /// type that defines the results of a measured angular characteristic evaluation.</remarks>
    ...
    /// <remarks> The AngleBetweenCharacteristicMeasurementType defines the results of a measured angle-between characteristic evaluation.</remarks>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    [System.SerializableAttribute()]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    ...
    public partial class AngleBetweenCharacteristicMeasurementType : AngularCharacteristicMeasurementBaseType
    {
        ...
        /// normal to the plane in which the angle-between characteristic is evaluated.</remarks>
        public MeasuredUnitVectorType AnalysisVector { get; set; }

        /// <remarks> The optional Vertex element is the point defining the
        /// location of the vertex of the measured angle.</remarks>
        public MeasuredPointType Vertex { get; set; }
    }

    /// <remarks> The AngleFromCharacteristicMeasurementType defines the results of a measured angle-from characteristic evaluation.</remarks>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    [System.SerializableAttribute()]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    ...
    public partial class AngleFromCharacteristicMeasurementType : AngularCharacteristicMeasurementBaseType
    {
        /// <remarks> The optional, measured AnalysisVector element used by the
        /// AnalysisMode gives a measured vector defining a unit vector
        /// normal to the plane in which the angle-from characteristic is evaluated.</remarks>
        public MeasuredUnitVectorType AnalysisVector { get; set; }
    ...
    /// <remarks> The AngleCharacteristicMeasurementType defines the results of a measured angle characteristic evaluation.</remarks>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    [System.SerializableAttribute()]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    ...
    /// for: angle-between, angle (the feature angle: included, draft, taper), angular-coordinate or angle-from.</remarks>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    [System.SerializableAttribute()]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
