...
namespace QIF_Model.QIFApplications.QIFRules
{
    ...
    /// DMEs. Rules sets for other types of decisions might be added.</remarks>
    ...
    {
        /// <remarks> The optional Version element gives version information about the rules.</remarks>
        ...
        /// Feature and characteristic information expressed elsewhere in other units must be converted to these units while using rules.</remarks>
        ...
        /// substitute feature algorithm to use.</remarks>
        public FeatureRulesType FeatureRules { get; set; }

        /// <remarks> The optional DMESelectionRules element defines a set of rules for selecting or not selecting DMEs.</remarks>
