...
namespace QIF_Model.QIFApplications.QIFStatistics
{
    ...
    /// measured over time to assess the stability of a measurement system.</remarks>
    ...
    public partial class StabilityStudyPlanType : StatisticalStudyPlanBaseType
    {
        ...
        /// <remarks> The SampleSize element specifies the number of samples to be used in the statistical study.</remarks>
        [System.Xml.Serialization.XmlElementAttribute()]
        public uint SampleSize { get; set; }

        /// <remarks> The SampleFrequency element specifies the sampling
        /// frequency n, n parts are measured in each sampling interval.</remarks>
        [System.Xml.Serialization.XmlElementAttribute()]
        public uint SampleFrequency { get; set; }

        /// <remarks> The SamplingInterval element specifies the sampling interval.</remarks>
