...
{
    /// <remarks The CharacteristicNominalBaseType is the abstract base type that defines a unique characteristic nominal./>
    public abstract class CharacteristicNominalBaseType : CharacteristicBaseType
    {
        /// <remarks The CharacteristicDefinitionId element is the QIF id of the associated characteristic definition./>
        ...
        /// ids of the instances of FeatureNominalType to which the CharacteristicNominal applies./>
        ...
        /// the purpose of evaluating this characteristic./>
        ...
        /// identifiers of instances derived from FeatureZoneBaseType that define zones of the features to be measured./>
        ...
        /// ids of CAD entities associated with this characteristic nominal./>
        ...
        /// ids of instances of EntityExternalType associated with this characteristic nominal./>
        public Primitives.ArrayReferenceFullType EntityExternalIds { get; set; }

        /// <remarks The optional Name element is the name of the characteristic nominal./>
    ...
    /// <remarks The ThreadCharacteristicNominalType defines a unique thread characteristic nominal./>
