...
namespace QIF_Model.QIFLibrary.Characteristics
{
    ...
    public class CharacteristicDesignatorType
    {
        ...
        /// number(or a number and a letter) in a balloon on a drawing or in a digital model./>
        ...
        /// using a widely accepted UUID generator./>
        [System.Xml.Serialization.XmlElementAttribute()]
        public Primitives.QPIdType UUID { get; set; }

        /// <remarks The optional Criticality element is the criticality level of the characteristic./>
        ...
        /// internally as visualization CAD data./>
        public CharacteristicBalloonType Balloon { get; set; }
    }

    /// <remarks The CriticalityType defines a criticality level for a characteristic and optionally defines a criticality area./>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    [System.SerializableAttribute()]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    ...
    public class CriticalityType
    {
        ...
        /// that describes the criticality./>
        ...
        /// criticality level by defining the area to which it applies./>
    ...
    /// <remarks The CriticalityLevelEnumType enumerates values that describe characteristic criticality levels./>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    [System.SerializableAttribute()]
    [System.Xml.Serialization.XmlTypeAttribute(Namespace = "http://qifstandards.org/xsd/qif3")]
    ...
    /// <remarks The CriticalityAreaEnumType enumerates values that describe characteristic criticality areas./>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    [System.SerializableAttribute()]
    [System.Xml.Serialization.XmlTypeAttribute(Namespace = "http://qifstandards.org/xsd/qif3")]
    ...
    public class CharacteristicBalloonType
    {
        ...
        /// designator balloon with respect to the characteristic to which it applies./>
        public CharacteristicBalloonLocationEnumType BalloonLocation { get; set; }

        /// <remarks The BalloonStyle element is the style of a characteristic designator balloon./>
    ...
    /// with respect to the print, drawing or model characteristic it describes./>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    [System.SerializableAttribute()]
    [System.Xml.Serialization.XmlTypeAttribute(Namespace = "http://qifstandards.org/xsd/qif3")]
    ...
    /// describe characteristic identifier balloon styles./>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    [System.SerializableAttribute()]
    [System.Xml.Serialization.XmlTypeAttribute(Namespace = "http://qifstandards.org/xsd/qif3")]
