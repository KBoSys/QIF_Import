...
namespace QIF_Model.QIFLibrary.Characteristics.Measurement
{
    ...
    /// defines the results of a measured characteristic evaluation holding measured/analyzed values./>
    ...
    {
        /// <remarks The Status element is the tolerance condition: pass (in tolerance), fail(out of tolerance), etc./>
        ...
        /// ids of the feature measurements to which this characteristic applies./>
        ...
        /// nominal, feature item, characteristic nominal or characteristic item./>
    ...
    /// of a measured surface texture characteristic evaluation./>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    [System.SerializableAttribute()]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    ...
    {
        /// <remarks The optional RoughnessAverage element is the measured Roughness Average(Ra) value./>
    ...
    /// Value must be one of the PassValues or FailValues given in the corresponding nominal characteristic./>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    [System.SerializableAttribute()]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    ...
    {
        /// <remarks The optional Value element is the measured value for the user-defined attribute characteristic./>
