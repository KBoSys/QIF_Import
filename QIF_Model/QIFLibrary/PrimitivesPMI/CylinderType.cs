...
{
    /// <remarks The CylinderType defines a cylinder to be used as a cylindrical area DatumTarget.It is not a feature./>
...
[System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    ...
    {
        /// <remarks The CenterPoint element is the center of the cylinder at one end./>
        public PointType CenterPoint { get; set; }

        /// <remarks The Diameter element is the diameter of the cylinder./>
        public LinearValueType Diameter { get; set; }

        /// <remarks The Axis element is the unit vector that gives the axis of the
        /// cylinder pointing from the end at which the center point is defined to the other end./>
        public UnitVectorType Axis { get; set; }

        /// <remarks The Length element is the length of the cylinder along its axis vector./>
