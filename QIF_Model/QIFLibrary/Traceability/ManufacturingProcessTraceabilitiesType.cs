...
namespace QIF_Model.QIFLibrary.Traceability
{
    ...
    /// manufacturing traceabilities that can be referenced by their QIF Id./>
    ...
    /// <remarks The ManufacturingProcessTraceabilityType defines traceability information for a manufacturing process./>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    [System.SerializableAttribute()]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    ...
    public partial class ManufacturingProcessTraceabilityType
    {
        ...
        /// <remarks The optional Description element gives the manufacturing process./>
        public string Description { get; set; }

        /// <remarks The optional Job element is the job number for the manufacturing process./>
        public string Job { get; set; }

        /// <remarks The optional Revision element is the revision number of the manufacturing process(NC cutter tape for example)./>
        ...
        /// manufacturing process traceability information for the previous manufacturing operation./>
        public QIFReferenceType PreviousOperationId { get; set; }

        /// <remarks The optional Path element gives the physical route used in a manufacturing process, e.g. "Line 3/Drilling machine #7/Spindle #2"./>
        public string Path { get; set; }

        /// <remarks The optional MachineManufacturerName element is the name of the company manufacturing the machine tool used in the process./>
        public string MachineManufacturerName { get; set; }

        /// <remarks The optional MachineIdentifier element is the identifier for the machine tool used in the process./>
        public string MachineIdentifier { get; set; }

        /// <remarks The optional OperatorIdentifier element gives an identifier for the person operating the machine tool used in the process./>
        public string OperatorIdentifier { get; set; }

        /// <remarks The optional Shift element gives the shift in which this manufacturing process took place./>
        public string Shift { get; set; }

        /// <remarks The optional Department element is the name of the department undertaking the manufacturing process./>
        public string Department { get; set; }

        /// <remarks The optional ResponsibilityIdentifier element gives an identifier for the entity responsible for this manufacturing process./>
        public string ResponsibilityIdentifier { get; set; }

        /// <remarks The optional PlantSector element is the plant sector in which the manufacturing process takes place./>
        public string PlantSector { get; set; }

        /// <remarks The optional ProcessParameters element gives the type and value of process parameters used in the manufacturing process./>
