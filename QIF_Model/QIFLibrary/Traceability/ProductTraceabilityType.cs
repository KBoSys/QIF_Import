...
{
    /// <remarks The ProductTraceabilityType defines traceability information for a part or assembly./>
    ...
    public partial class ProductTraceabilityType
    {
        ...
        /// defined to be used in the setup of a measurement plan./>
        ...
        /// <remarks The optional InspectionSoftwareItems element is a list of software to be used in the inspection./>
        public InspectionSoftwareItemsType InspectionSoftwareItems { get; set; }

        /// <remarks The optional InspectionProgram element gives information abouta program(such as a CMM program) to be used to inspect the product./>
        public InspectionProgramType InspectionProgram { get; set; }

        /// <remarks The optional MeasurementDeviceIds element is a list of references to the measurement devices to be used in the inspection./>
