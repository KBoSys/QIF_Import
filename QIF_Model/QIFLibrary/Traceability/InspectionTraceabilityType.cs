...
{
    /// <remarks The InspectionTraceabilityType defines information to support traceability of the inspection report./>
    ...
    public partial class InspectionTraceabilityType
    {
        ...
        /// InspectionMode element is FAI_Partial and may be used for any other partial inspection./>
        public PartialInspectionType PartialInspection { get; set; }

        /// <remarks The optional NotableEvents element is a list of notable events associated with the inspection./>
        public IntermediatesPMI.NotableEventsType NotableEvents { get; set; }

        /// <remarks The optional NotedEvents element is a list of noted events associated with the inspection./>
        ...
        /// of both inspection and the analysis./>
        ...
        /// a program(such as a CMM program) used or to be used to in the inspection./>
        ...
        /// AS9102B first article inspection report, for example)./>
        ...
        /// in GMT(not local time) when the report was completed./>
        public System.DateTime ReportPreparationDate { get; set; }

        [System.Xml.Serialization.XmlIgnoreAttribute()]
        public bool ReportPreparationDateSpecified { get; set; }

        /// <remarks The optional ReportType element is the type of inspection report./>
        [System.Xml.Serialization.XmlElementAttribute(DataType = "token")]
        public string ReportType { get; set; }

        /// <remarks The optional SecurityClassification element gives the security classification of the inspection report./>
        public PrimitivesPMI.SecurityClassificationType SecurityClassification { get; set; }

        /// <remarks The optional PlantLocation element gives information about the location of the plant where the inspection was performed./>
        ...
        /// preparing this file.This is relevant if the file contains results./>
    ...
    /// <remarks The ErrorsType defines a list of errors that occurred during the measurement process./>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    [System.SerializableAttribute()]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    ...
    {
        /// <remarks Each Error element describes an error that occurred during the measurement process./>
        [System.Xml.Serialization.XmlElementAttribute("Error")]
        public string[] Errors { get; set; }

        /// <remarks The required n attribute is the number of Error elements in the set./>
