...
namespace QIF_Model.QIFLibrary.Expressions
{
    ...
    /// chosen to avoid conflicts with reserved words and macro definitions in common computer languages.)/>
    ...
    /// expressions.All derived types of BooleanExpressionBaseType evaluate to true or false./>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    [System.SerializableAttribute()]
    ...
    public partial class ShapeClassIsType : BooleanExpressionBaseType
    {
        ...
        /// which to test the shape class of the part on which the feature is located./>
    ...
    /// the FeatureRules of the QIFRulesType since those rules are already feature specific./>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    [System.SerializableAttribute()]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    ...
    {
        /// <remarks The required val attribute is the feature type against which to test the feature type of the feature./>
        [System.Xml.Serialization.XmlAttributeAttribute("val")]
    ...
    /// being selected or a DME is being selected. Otherwise, it evaluates to false./>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    [System.SerializableAttribute()]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    ...
    {
        /// <remarks The required val attribute is the characteristic type against which to test the characteristic type of the feature./>
        [System.Xml.Serialization.XmlAttributeAttribute("val")]
    ...
    /// which means either the feature is external or the feature is neither internal nor external./>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    [System.SerializableAttribute()]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    ...
    /// tokens are the same length and corresponding characters of the two tokens are the same./>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    [System.SerializableAttribute()]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    ...
    /// the second ArithmeticExpression element minus ComparisonTiny. Otherwise, it evaluates to false./>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    [System.SerializableAttribute()]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    ...
    /// <remarks The ConstantIsType evaluates to true if the val is QIF_TRUE and evaluates to false if the val is QIF_FALSE./>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    [System.SerializableAttribute()]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    ...
    /// evaluate to false. Otherwise, the BooleanEqualType evaluates to false./>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    [System.SerializableAttribute()]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
