...
{
    /// <remarks The TorusFeatureMeasurementType defines the torus feature measurement information for an individual torus feature./>
    ...
    {
        /// <remarks The optional Location element is the measured center of the torus./>
        public MeasuredPointType Location { get; set; }

        /// <remarks The optional AxisVector element is the measured unit axis vector of the torus./>
        public MeasuredUnitVectorType AxisVector { get; set; }

        /// <remarks The optional MinorDiameter element is the measured minor
        /// diameter of the torus based on the substitute feature data fitting algorithm setting./>
        ...
        /// of the torus from a report or an analysis./>
