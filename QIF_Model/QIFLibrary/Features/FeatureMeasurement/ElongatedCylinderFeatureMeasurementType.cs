...
namespace QIF_Model.QIFLibrary.Features.FeatureMeasurement
{
    ...
    /// cylinder feature measurement information for an individual elongated cylinder feature./>
    ...
    public partial class ElongatedCylinderFeatureMeasurementType : SurfaceFeatureMeasurementBaseType
    {
        ...
        /// midway between the cylindrical ends./>
        public MeasuredPlaneType CenterPlane { get; set; }

        /// <remarks The optional Length element is the measured length (i.e.,
        /// size) of the elongated cylinder./>
        public MeasuredLinearValueType Length { get; set; }

        /// <remarks The optional LengthMax element is the maximum length of the elongated cylinder from a report or an analysis./>
        public MeasuredLinearValueType LengthMax { get; set; }

        /// <remarks The optional LengthMin element is the minimum length of the elongated cylinder from a report or an analysis./>
        public MeasuredLinearValueType LengthMin { get; set; }

        /// <remarks The optional Depth element is the measured depth of the elongated cylinder./>
        public MeasuredLinearValueType Depth { get; set; }

        /// <remarks The optional DepthMax element is the maximum depth of the elongated cylinder from a report or an analysis./>
        public MeasuredLinearValueType DepthMax { get; set; }

        /// <remarks The optional DepthMin element is the minimum depth of the elongated cylinder from a report or an analysis./>
        ...
        /// elongated cylinder does not extend from the location point in the direction opposite the depth vector./>
        public MeasuredUnitVectorType DepthVector { get; set; }

        /// <remarks The optional Form element is the form error (cylindricity)
        /// of the elongated cylinder from a report or an analysis./>
