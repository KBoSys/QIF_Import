...
namespace QIF_Model.QIFLibrary.Features.FeatureMeasurement
{
    ...
    /// angled planes feature measurement information for an individual opposite angled planes feature./>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    [System.SerializableAttribute()]
    ...
    public partial class OppositeAngledPlanesFeatureMeasurementType : SurfaceFeatureMeasurementBaseType
    {
        ...
        /// <remarks The optional DepthVector element is the measured unit vector of the depth axis of the feature./>
        ...
        /// or has draft, the width applies at the locating point./>
        public MeasuredLinearValueType Width { get; set; }

        /// <remarks The optional WidthMin element is the minimum width of the
        /// opposite angled planes feature from a report or an analysis./>
        ...
        /// draft then the length applies at the locating point./>
        ...
        /// <remarks The optional Depth element is the measured depth of opposite angled planes feature in the direction of the depth vector./>
        public MeasuredLinearValueType Depth { get; set; }

        /// <remarks This optional compositor allows for a taper angle or a draft angle, but not both./>
