...
{
    /// <remarks The CylinderFeatureMeasurementType defines the cylinder feature measurement information for an individual cylinder feature./>
    ...
    public partial class CylinderFeatureMeasurementType : SurfaceFeatureMeasurementBaseType
    {
        ...
        /// the cylinder based on the substitute feature data fitting algorithm setting./>
        public MeasuredLinearValueType Diameter { get; set; }

        /// <remarks The optional Length element is the measured length of the
        /// cylinder from the start point in the direction of the cylinder axis./>
        public MeasuredLinearValueType Length { get; set; }

        /// <remarks The optional DiameterMin element is the minimum diameter of the cylinder from a report or an analysis./>
        public MeasuredLinearValueType DiameterMin { get; set; }

        /// <remarks The optional DiameterMax element is the maximum diameter of the cylinder from a report or an analysis./>
        ...
        /// The StartVector of the sweep must lie in a plane perpendicular to the axis of the cylinder./>
        ...
        /// for use when it has been possible to measure the start and end of the sweep./>
        public SweepType SweepFull { get; set; }

        /// <remarks The optional Form element is the form error (cylindricity)
        /// of the cylinder from a report or an analysis./>
