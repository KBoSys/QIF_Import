...
namespace QIF_Model.QIFLibrary.Features.FeatureMeasurement
{
    ...
    /// segment feature measurement information for an individual toroidal segment feature./>
    ...
    {
        /// <remarks The optional Location element is the measured center of the toroidal segment./>
        public MeasuredPointType Location { get; set; }

        /// <remarks The optional AxisVector element is the measured unit axis vector of the toroidal segment./>
        ...
        /// <remarks The optional Form element is the form error (toroidicity) of the toroidal segment from a report or an analysis./>
