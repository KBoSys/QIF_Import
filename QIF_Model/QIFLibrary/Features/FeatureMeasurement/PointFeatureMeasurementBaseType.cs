...
namespace QIF_Model.QIFLibrary.Features.FeatureMeasurement
{
    ...
    /// <remarks The EdgePointFeatureMeasurementType defines the edge-point feature measurement information for an individual edge-point feature./>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    [System.SerializableAttribute()]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    ...
    {
        /// <remarks The optional Location element is the measured location of a point on the edge between two surfaces./>
        public MeasuredPointType Location { get; set; }

        /// <remarks The optional Normal element is the measured unit normal vector of the edge surface./>
        public MeasuredUnitVectorType Normal { get; set; }

        /// <remarks The optional AdjacentNormal element is the measured unit normal vector of the surface adjacent to the edge surface./>
