...
namespace QIF_Model.QIFLibrary.Features.FeatureMeasurement
{
    ...
    /// circle feature measurement information for an individual elongated circle feature./>
    ...
    public partial class ElongatedCircleFeatureMeasurementType : CurveFeatureMeasurementBaseType
    {
        ...
        /// diameter of the elongated circle from a report or an analysis./>
        ...
        /// elongated circle feature./>
        public MeasuredPointAndVectorType CenterLine { get; set; }

        /// <remarks The optional Normal element is the measured normal vector
        /// of the plane of the elongated circle feature./>
        public MeasuredUnitVectorType Normal { get; set; }

        /// <remarks The optional Length element is the measured length (i.e., size) of the elongated circle./>
        public MeasuredLinearValueType Length { get; set; }

        /// <remarks The optional LengthMax element is the maximum length of the elongated circle from a report or an analysis./>
        public MeasuredLinearValueType LengthMax { get; set; }

        /// <remarks The optional LengthMin element is the minimum length of the elongated circle from a report or an analysis./>
        public MeasuredLinearValueType LengthMin { get; set; }

        /// <remarks The optional Form element is the form error (circularity) of the elongated circle from a report or an analysis./>
