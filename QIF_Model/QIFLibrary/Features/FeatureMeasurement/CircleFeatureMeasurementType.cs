...
{
    /// <remarks The CircleFeatureMeasurementType defines measurement information for an individual circle feature./>
    ...
    {
        /// <remarks The optional Location element is the measured center point of the circle./>
        public MeasuredPointType Location { get; set; }

        /// <remarks The optional Normal element is the measured normal vector of the plane of the circle./>
        public MeasuredUnitVectorType Normal { get; set; }

        /// <remarks The optional Diameter element is the measured diameter of
        /// the circle based on the substitute feature data fitting algorithm setting./>
        public MeasuredLinearValueType Diameter { get; set; }

        /// <remarks The optional DiameterMin element is the minimum measured diameter of the circle from a report or an analysis./>
        public MeasuredLinearValueType DiameterMin { get; set; }

        /// <remarks The optional DiameterMax element is the maximum measured diameter of the circle from a report or an analysis./>
        public MeasuredLinearValueType DiameterMax { get; set; }

        /// <remarks The optional Form element is the form error (roundness) of the circle from a report or an analysis./>
        ...
        /// start direction and the swept angle.The StartVector of the sweep must lie in the plane of the circle./>
        ...
        /// use when it has been possible to measure the start and end of the sweep./>
