...
namespace QIF_Model.QIFLibrary.Features.FeatureMeasurement
{
    ...
    /// angled lines feature measurement information for an individual opposite angled lines feature./>
    ...
    public partial class OppositeAngledLinesFeatureMeasurementType : CurveFeatureMeasurementBaseType
    {
        ...
        /// vector of the plane of the opposite angled lines feature./>
        ...
        /// opposite angled lines are tapered, the width applies at the locating point./>
        public MeasuredLinearValueType Width { get; set; }

        /// <remarks The optional WidthMin element is the minimum width of the opposite angled lines feature from a report or an analysis./>
        public MeasuredLinearValueType WidthMin { get; set; }

        /// <remarks The optional WidthMax element is the maximum width of the opposite angled lines feature from a report or an analysis./>
        public MeasuredLinearValueType WidthMax { get; set; }

        /// <remarks The optional Length element is the measured length of the
        /// centerline of the opposite angled lines feature based on the substitute feature data fitting algorithm setting./>
        public MeasuredLinearValueType Length { get; set; }

        /// <remarks The optional LengthMin element is the minimum length of the
        /// opposite angled lines feature from a report or an analysis./>
        ...
        /// of the opposite angled lines feature./>
        ...
        /// angled lines feature from a report or an analysis./>
