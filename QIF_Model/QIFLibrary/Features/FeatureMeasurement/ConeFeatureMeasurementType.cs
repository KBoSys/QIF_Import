...
{
    /// <remarks The ConeFeatureMeasurementType defines the cone feature measurement information for an individual cone feature./>
    ...
    public partial class ConeFeatureMeasurementType : SurfaceFeatureMeasurementBaseType
    {
        ...
        /// the locating point into the expanding end of the cone./>
        ...
        /// locating point is at the vertex this value will be zero./>
        public MeasuredLinearValueType Diameter { get; set; }

        /// <remarks The optional DiameterMin element is the measured minimum
        /// diameter at the locating point of the cone from a report or an analysis./>
        ...
        /// <remarks This optional compositor defines the measured angle of the cone./>
        ...
        /// pointed end then this element must be omitted./>
        public MeasuredLinearValueType SmallEndDistance { get; set; }

        /// <remarks The optional LargeEndDistance element is the measured
        /// distance from the locating point to the large end of a truncated cone along the axis vector./>
        ...
        /// The StartVector of the sweep must lie in a plane perpendicular to the axis of the cone./>
        ...
        /// <remarks The optional Form element is the form error (conicity) of the cone from a report or an analysis./>
        public MeasuredLinearValueType Form { get; set; }
    }

    /// <remarks The ConicalSegmentFeatureMeasurementType defines the conical
    /// segment feature measurement information for an individual conical segment feature./>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    [System.SerializableAttribute()]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
