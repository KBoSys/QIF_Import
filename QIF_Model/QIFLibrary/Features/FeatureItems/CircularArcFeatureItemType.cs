...
namespace QIF_Model.QIFLibrary.Features.FeatureItems
{
    ...
    /// A circular arc feature is a two dimensional circular segment./>
    public partial class CircularArcFeatureItemType : CurveFeatureItemBaseType
    {
        /// <remarks The DeterminationMode element is the means by which the circular arc feature measurement is determined./>
    ...
    public partial class CircularArcMeasurementDeterminationType
    {
        ...
        /// The Set element signifies that the circular arc measurement is set to its nominal value./>
    ...
    /// <remarks The CircularArcCheckedFeatureType defines that a circular arc feature is checked./>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    [System.SerializableAttribute()]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    ...
    public partial class CircularArcCheckedFeatureType
    {
        ...
        /// circular arc check(measurement or construction)./>
    ...
    public partial class CircularArcCheckedType
    {
        ...
        /// The Constructed element signifies that the circular arc is constructed./>
