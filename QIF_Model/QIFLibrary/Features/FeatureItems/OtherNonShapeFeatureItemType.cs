/*! \file OtherNonShapeFeatureItemType.cs
    \brief Defines a non-shape feature item
...
namespace QIF_Model.QIFLibrary.Features.FeatureItems
{
    ...
    public partial class OtherNonShapeFeatureItemType : NonShapeFeatureItemBaseType
    {
    }
}
