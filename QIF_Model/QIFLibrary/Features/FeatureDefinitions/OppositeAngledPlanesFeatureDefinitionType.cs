...
namespace QIF_Model.QIFLibrary.Features.FeatureDefinitions
{
    ...
    /// information that can be common to one or more opposite angled planes features./>
    ...
    public partial class OppositeAngledPlanesFeatureDefinitionType : SurfaceFeatureDefinitionBaseType
    {
        ...
        /// Because the opposite angled planes of the feature are tapered or have a draft angle, the width applies at the locating point./>
        ...
        /// then the length applies at the depth of the locating point./>
        ...
        /// point of the center plane./>
        public SlotEndType EndType { get; set; }

        /// <remarks The optional Depth element is the depth of the opposite angled planes feature./>
        ...
        /// end expands in size like a dumbbell or not is defined by the Expanded element./>
        ...
        /// <remarks This compositor allows for a taper angle or a draft angle, but not both./>
