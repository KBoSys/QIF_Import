...
namespace QIF_Model.QIFLibrary.Features.FeatureDefinitions
{
    ...
    /// information that can be common to one or more opposite parallel	planes features.</remarks>
    [System.SerializableAttribute()]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true, Namespace = "http://qifstandards.org/xsd/qif3")]
    public class OppositeParallelPlanesFeatureDefinitionType : SurfaceFeatureDefinitionBaseType
    {
        /// <remarks> The InternalExternal element indicates whether the feature is internal (slot, groove) or external(rib, web, block).</remarks>
        public InternalExternalEnumType InternalExternal { get; set; }

        /// <remarks> The Width element is the nominal width of this feature of size.</remarks>
        public LinearValueType Width { get; set; }

        /// <remarks> The optional Length element is the nominal length of the feature parallel to the length vector in the center-plane.</remarks>
        ...
        /// LengthVector passing through the location point of the center plane.</remarks>
        public SlotEndType EndType { get; set; }

        /// <remarks> The optional Depth element is the depth of the opposite parallel planes feature.</remarks>
        ...
        /// the boss at the base of the boss, while THROUGH means that there is no material there.</remarks>
        ...
        /// defined by the Expanded element.</remarks>
