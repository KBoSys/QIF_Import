...
namespace QIF_Model.QIFLibrary.Features.FeatureDefinitions
{
    ...
    public partial class TorusFeatureDefinitionType : SurfaceFeatureDefinitionBaseType
    {
        ...
        /// <remarks The MinorDiameter element is the nominal minor diameter of the torus./>
        public LinearValueType MinorDiameter { get; set; }

        /// <remarks The MajorDiameter element is the nominal major diameter of the torus./>
