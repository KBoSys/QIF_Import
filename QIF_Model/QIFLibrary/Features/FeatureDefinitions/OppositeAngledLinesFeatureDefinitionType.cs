...
namespace QIF_Model.QIFLibrary.Features.FeatureDefinitions
{
    ...
    /// information that can be common to one or more opposite angled lines features./>
    ...
    public partial class OppositeAngledLinesFeatureDefinitionType : CurveFeatureDefinitionBaseType
    {
        ...
        /// is internal (slot, groove) or external(rib, web, block)./>
        ...
        /// Because the feature is tapered, the width applies at the locating point./>
        public LinearValueType Width { get; set; }

        /// <remarks The optional Length element is the nominal length of the
        /// feature from end to end along the centerline./>
        public LinearValueType Length { get; set; }

        /// <remarks The EndType element is the type of the opposite angled lines feature's ends: round, flat, expanded, or open./>
        ...
        /// if negative, the opposite angled lines close in the direction of the centerline vector./>
        ...
        /// centerline vector is open and the other end is closed./>
        ...
        /// a dumbbell or not is defined by the Expanded element./>
        ...
        /// size like a dumbbell or not is defined by the Expanded element./>
