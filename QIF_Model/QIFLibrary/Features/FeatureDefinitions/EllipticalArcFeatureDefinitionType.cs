...
namespace QIF_Model.QIFLibrary.Features.FeatureDefinitions
{
    ...
    public partial class EllipticalArcFeatureDefinitionType : CurveFeatureDefinitionBaseType
    {
        ...
        /// <remarks The MajorDiameter element is the nominal major diameter of the elliptical arc./>
        public LinearValueType MajorDiameter { get; set; }

        /// <remarks The MinorDiameter element is the nominal minor diameter of the elliptical arc./>
