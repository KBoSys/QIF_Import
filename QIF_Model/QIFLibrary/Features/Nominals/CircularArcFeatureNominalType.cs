...
{
    /// <remarks The CircularArcFeatureNominalType defines feature nominal information for an individual circular arc feature./>
    ...
    {
        /// <remarks The Location element is the nominal center point of the circular arc./>
        ...
        /// The StartVector of the Sweep must lie in the plane of the circular arc./>
        public SweepType Sweep { get; set; }

        /// <remarks The Normal element is the nominal unit normal vector of the plane of the circular arc./>
        public UnitVectorType Normal { get; set; }

        /// <remarks The optional Constructed element signifies that the circular
        /// arc is constructed and provides details of the construction method./>
