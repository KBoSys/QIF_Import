...
namespace QIF_Model.QIFLibrary.Features.Nominals
{
    ...
    {
        /// <remarks The Normal element is the normal of the plane of the circle./>
        public UnitVectorType Normal { get; set; }

        /// <remarks The Center element is the center of the circle./>
        ...
        /// locations defined by the pattern./>
