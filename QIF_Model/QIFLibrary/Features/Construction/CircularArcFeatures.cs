...
{
    /// <remarks The CircularArcExtractType defines a circular arc construction by the extraction of a circular arc from a curve feature./>
    ...
    {
        /// <remarks The CurveFeature element identifies the curve from which the circular arc is extracted./>
    ...
    /// the retrieval of a circular arc from a scanned surface feature (point cloud)./>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    [System.SerializableAttribute()]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    ...
    {
        /// <remarks The SurfaceFeature element identifies the scanned surface feature from which the circular arc is retrieved./>
        ...
        /// arc nominal axis vector at which the circular arc is to be retrieved./>
        public LinearValueType Depth { get; set; }
    }

    /// <remarks The CircularArcTransformType defines a circular arc construction by
    /// the transformation of a circular arc through the specified nominal or actual coordinate system./>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    [System.SerializableAttribute()]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    ...
    {
        /// <remarks The BaseArc element identifies the circular arc to be transformed./>
        public BaseFeatureType BaseArc { get; set; }

        /// <remarks The Transformation element identifies the coordinate system to be used to transform the base circular arc./>
    ...
    {
        /// <remarks The BaseFeature element identifies the feature to be cast to a circular arc./>
        public BaseFeatureType BaseFeature { get; set; }
    }

    /// <remarks The CircularArcCopyType defines a copied circular arc construction./>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    [System.SerializableAttribute()]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    ...
    {
        /// <remarks The BaseArc element identifies the circular arc to be copied./>
        public BaseFeatureType BaseArc { get; set; }
    }

    /// <remarks The CircularArcProjectionType defines a projected circular arc
    /// construction with the circular arc to be projected and the projection plane./>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    [System.SerializableAttribute()]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    ...
    {
        /// <remarks The ProjectionArc element identifies the circular arc to be projected./>
        public BaseFeatureType ProjectionArc { get; set; }

        /// <remarks The ProjectionPlane element identifies the plane onto which the circular arc is to be projected./>
    ...
    public partial class CircularArcBestFitType : ConstructionMethodBaseType
    {
        ...
        /// base features must be 3 or greater./>
