...
{
    /// <remarks The CircleFromScanType defines a circle construction by the retrieval of a circle from a scanned surface feature(point cloud)./>
    ...
    {
        /// <remarks The SurfaceFeature element identifies the scanned surface feature from which the circle is retrieved./>
        ...
        /// shell's axis passes through the feature's center point./>
        public LinearValueType SearchRadius { get; set; }

        /// <remarks The Depth element is the measuring depth down the circle nominal axis vector at which the circle is to be retrieved./>
        public LinearValueType Depth { get; set; }
    }

    /// <remarks The CircleFromConeType defines the construction of a circle from a cone.
    /// The circle will be located either at a specified diameter on the cone or at a specified distance from the vertex of the cone./>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    [System.SerializableAttribute()]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    ...
    /// transformation of a circle through the specified nominal or actual coordinate system./>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    [System.SerializableAttribute()]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    ...
    {
        /// <remarks The BaseCircle element identifies the circle to be transformed./>
        public BaseFeatureType BaseCircle { get; set; }

        /// <remarks The Transformation element identifies the coordinate system to be used to transform the base circle./>
    ...
    /// feature.The point and base feature are both coplanar with the circle./>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    [System.SerializableAttribute()]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    ...
    {
        /// <remarks The TangentFeature element identifies the base feature to which the constructed circle is tangent./>
        public BaseFeatureType TangentFeature { get; set; }

        /// <remarks The PointFeature element identifies the point feature through which the constructed circle passes./>
        public BaseFeatureType PointFeature { get; set; }
    }

    /// <remarks The CircleTangentType defines the construction of a circle with a
    /// nominal diameter tangent to two base features coplanar with the circle./>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    [System.SerializableAttribute()]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    ...
    {
        /// <remarks Each TangentFeature element identifies a base feature for the tangent circle construction./>
    ...
    {
        /// <remarks The BaseFeature element identifies the feature to be cast to a circle./>
        public BaseFeatureType BaseFeature { get; set; }
    }

    /// <remarks The CircleCopyType defines a copied circle construction./>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    [System.SerializableAttribute()]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    ...
    {
        /// <remarks The BaseCircle element identifies the circle to be copied./>
        public BaseFeatureType BaseCircle { get; set; }
    }

    /// <remarks The CircleProjectionType defines a projected circle construction with the circle to be projected and the projection plane./>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    [System.SerializableAttribute()]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    ...
    {
        /// <remarks The ProjectionCircle element identifies the circle to be projected./>
        public BaseFeatureType ProjectionCircle { get; set; }

        /// <remarks The ProjectionPlane element identifies the plane onto which the base circle is to be projected./>
    ...
    /// of revolution with a plane, two cones of differing angles, or a cone with a cylinder./>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    [System.SerializableAttribute()]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    ...
    {
        /// <remarks Each IntersectionFeature element identifies a feature to be used to construct the circle of intersection./>
    ...
    public partial class CircleRecompType : ConstructionMethodBaseType
    {
        ...
        /// BaseFeaturePointSets in the list must be 3 or greater./>
    ...
    public partial class CircleBestFitType : ConstructionMethodBaseType
    {
        ...
        /// used for the construction of a circle.The number of base features must be 3 or greater./>
