...
namespace QIF_Model.QIFLibrary.Geometry
{
    ...
    /// The center of the torus is at the AxisPoint of the Axis, and the axis of the torus is the Axis./>
    ...
    {
        /// <remarks The Torus23Core element defines the mathematical core of this surface type./>
        public Torus23CoreType Torus23Core { get; set; }
    }

    /// <remarks The Sphere23Type defines the geometric entity
    /// 'spherical_surface(u,v):R2->R3'. Any surface can have an additional transformation matrix./>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    [System.SerializableAttribute()]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    ...
    {
        /// <remarks The Sphere23Core element defines the mathematical core of this surface type./>
    ...
    {
        /// <remarks The Cylinder23Core element defines the mathematical core of this surface type./>
    ...
    {
        /// <remarks The Cone23Core element defines the mathematical core of this surface type./>
        public Cone23CoreType Cone23Core { get; set; }
    }

    /// <remarks The Plane23Type defines the geometric entity 'planar_surface(u,v):R2->R3'. 
    /// Any surface can have an additional transformation matrix./>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    [System.SerializableAttribute()]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    ...
    {
        /// <remarks The Plane23Core element defines the mathematical core of this surface type./>
    ...
    {
        /// <remarks The Offset23Core element defines the mathematical core of this surface type./>
        public Offset23CoreType Offset23Core { get; set; }
    }

    /// <remarks The Ruled23Type defines the geometric entity
    /// 'ruled_surface(u,v):R2->R3'. Any surface can have an additional transformation matrix./>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    [System.SerializableAttribute()]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    ...
    {
        /// <remarks The Ruled23Core element defines the mathematical core of this surface type./>
    ...
    {
        /// <remarks The Extrude23Core element defines the mathematical core of this surface type./>
    ...
    {
        /// <remarks The Revolution23Core element defines the mathematical core of this surface type./>
        public Revolution23CoreType Revolution23Core { get; set; }
    }
    ...
    {
        /// <remarks The Spline23Core element defines the mathematical core of this surface type./>
        public Spline23CoreType Spline23Core { get; set; }
    }
    ...
    {
        /// <remarks The Nurbs23Core element defines the mathematical core of this surface type./>
        public Nurbs23CoreType Nurbs23Core { get; set; }
    }
}
