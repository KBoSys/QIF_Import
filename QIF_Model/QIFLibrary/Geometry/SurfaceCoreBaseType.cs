...
{
    /// <remarks The Attr23CoreEnumType enumerates values that describe the surface form/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    [System.SerializableAttribute()]
    [System.Xml.Serialization.XmlTypeAttribute(Namespace = "http://qifstandards.org/xsd/qif3")]
    public enum Attr23CoreEnumType
    {
        /// <remarks a freeform surface (NURBS, spline etc.)/>
        FREEFORM,

        /// <remarks a cylindrical surface/>
        CYLINDER,

        /// <remarks a conical surface/>
        CONE,

        /// <remarks a toroidal surface/>
        TORUS,

        /// <remarks a spherical surface/>
        SPHERE,

        /// <remarks a plane surface/>
        PLANE,
    }

    /// <remarks The SurfaceCoreBaseType is the abstract base type for all mathematical cores of surfaces present in the CAD scene./>
    ...
    {
        /// <remarks The optional form attribute describes the surface form./>
    ...
    /// <remarks The Torus23CoreType defines the mathematical core of the geometric entity 'toroidal_surface(u,v):R2->R3'./>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    [System.SerializableAttribute()]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    ...
    public partial class Torus23CoreType : SurfaceCoreBaseType
    {
        ...
        /// <remarks The DiameterMinor element is the torus minor diameter./>
        public double DiameterMinor { get; set; }

        /// <remarks The DiameterMajor element is the torus major diameter./>
        public double DiameterMajor { get; set; }

        /// <remarks The Axis is the unit axis vector of the torus./>
        public AxisType Axis { get; set; }

        /// <remarks The LatitudeLongitudeSweep element specifies the
        /// sweep angles in the two directions analogous to terrestrial latitude and longitude./>
        ...
        /// A value of 0 (or false) means the v direction must not be inverted./>
        [System.Xml.Serialization.XmlAttributeAttribute("turnedV")]
        [System.ComponentModel.DefaultValueAttribute(false)]
        public bool TurnedV { get; set; } = false;

        /// <remarks The optional offsetV attribute specifies the offset of the v parameter before passing the parameter to the torus formula./>
        ...
        /// <remarks The optional scaleU attribute is the scaling coefficient of the u direction of the parametric space./>
        ...
        /// <remarks The optional scaleV attribute is the scaling coefficient of the v direction of the parametric space./>
        [System.Xml.Serialization.XmlAttributeAttribute("scaleV")]
        [System.ComponentModel.DefaultValueAttribute(1D)]
        public double ScaleV { get => scaleVField; set => scaleVField = value; }
    }

    /// <remarks The Sphere23CoreType defines the mathematical core of the geometric entity 'spherical_surface(u,v):R2->R3'./>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    [System.SerializableAttribute()]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    ...
    {
        /// <remarks The Diameter element is diameter of the sphere./>
        public double Diameter { get; set; }

        /// <remarks The Location element is a 3D point which defines the sphere center./>
    ...
    /// <remarks The Cylinder23CoreType defines the mathematical core of the geometric entity 'cylindrical_surface(u,v):R2->R3'./>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    [System.SerializableAttribute()]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    ...
    {
        /// <remarks The Diameter element is diameter of the cylinder./>
        public double Diameter { get; set; }

        /// <remarks The Length element is height of the cylinder - distance between the cylinder top and bottom./>
        public double Length { get; set; }

        /// <remarks The Axis is the unit axis vector of the cylinder./>
        public AxisType Axis { get; set; }
    ...
    /// <remarks The Cone23CoreType defines the mathematical core of the geometric entity 'conical_surface(u,v):R2->R3'./>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    [System.SerializableAttribute()]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    ...
    {
        /// <remarks The DiameterBottom element is cone diameter at the bottom./>
        public double DiameterBottom { get; set; }

        /// <remarks The DiameterBottom element is cone diameter at the top./>
        public double DiameterTop { get; set; }

        /// <remarks The Length element is the cone height - distance between the cone top and bottom./>
        public double Length { get; set; }

        /// <remarks The Axis is the unit axis vector of the cone./>
        public AxisType Axis { get; set; }
    ...
    /// vectors: DirU and DirV.The domain values (domainU and domainV) 'limit' the plane infinity./>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    [System.SerializableAttribute()]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    ...
    public partial class Plane23CoreType : SurfaceCoreBaseType
    {
        ...
        /// <remarks The Origin element gives one corner of the parallelogram./>
        public PointSimpleType Origin { get; set; }

        /// <remarks The DirU element is a vector that defines the direction and
        /// scaling of U-parameter lines.The DirU vector must not be parallel or anti-parallel to the DirV vector./>
        public VectorSimpleType DirU { get; set; }

        /// <remarks The DirV element is a vector that defines the direction and scaling of V-parameter lines./>
    ...
    /// <remarks The SurfaceCoreType represents a container for a single surface./>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    [System.SerializableAttribute()]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    ...
    {
        /// <remarks The Surface element is a surface (surface(u, v):R2->R3)./>
    ...
    {
        /// <remarks The Distance element is the offset distance./>
        public double Distance { get; set; }

        /// <remarks The Surface element is the base surface for the offsetting./>
    ...
    /// corresponding points on two space curves by a set of linear segments./>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    [System.SerializableAttribute()]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    ...
    {
        /// <remarks The Curve element is a 3D base curve./>
        ...
        /// curve is inverted.A value of 0 (or false) means the second curve is not inverted./>
    ...
    {
        /// <remarks The TerminationPoint specifies the termination point. The corresponding start point is located at the profile curve./>
        public PointSimpleType TerminationPoint { get; set; }

        /// <remarks The Curve element is the curve to be used as the profile of extrusion./>
        public Curve13CoreType Curve { get; set; }
    }

    /// <remarks The Revolution23CoreType defines the mathematical core of the geometric entity 'surface_of_revolution(u,v):R2->R3'./>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    [System.SerializableAttribute()]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    ...
    public partial class Revolution23CoreType : SurfaceCoreBaseType
    {
        ...
        /// <remarks The Axis is the unit axis vector of rotation./>
        public AxisType Axis { get; set; }

        /// <remarks The Generatrix element is the 3D curve to be rotated around the axis./>
        public Curve13CoreType Generatrix { get; set; }

        /// <remarks The required angle attribute specifies start and terminate rotation angles./>
    ...
    {
        /// <remarks The KnotsU element is the knot vector in the u direction (the u spline breakpoints)./>
        public ArrayDoubleType KnotsU { get; set; }

        /// <remarks The KnotsV element is the knot vector in the v direction (the v spline breakpoints)./>
        ...
        /// The size of this array is 'the number of the u spline breakpoints' - 1./>
        ...
        /// The order is 'the degree of the polynomial' + 1.
        /// The size of this array is 'the number of the v spline breakpoints' - 1./>
        ...
        /// The total size of this array is the sum of all patch coefficients./>
        ...
        /// A value of 0 (or false) means the surface is not normalized./>
        [System.Xml.Serialization.XmlAttributeAttribute("normalized")]
        [System.ComponentModel.DefaultValueAttribute(false)]
        public bool Normalized { get; set; } = false;
    }

    /// <remarks The Nurbs23CoreType defines the mathematical core of the geometric entity 'NURBS_surface(u,v):R2->R3'./>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    [System.SerializableAttribute()]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    ...
    {
        /// <remarks The OrderU element is the order in the u direction (= degree + 1)./>
        public uint OrderU { get; set; }

        /// <remarks The OrderU element is the order in the v direction (= degree + 1)./>
        ...
        /// array is ('number of the u-knots' - 'the u-order') * ('number of the v-knots' - 'the v-order')./>
        ...
        /// of its elements corresponds to the number of control points./>
