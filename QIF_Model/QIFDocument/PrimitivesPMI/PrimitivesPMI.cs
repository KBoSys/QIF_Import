...
/*
  ...
  <xs:simpleType name = "SecurityClassificationEnumType" >
    < xs:annotation>
      <xs:documentation>
    ...
    <xs:restriction base="xs:NMTOKEN">
      ...
      < xs:enumeration value = "EU_RESTRICTED" />
      < xs:enumeration value = "WEU_RESTRICTED" />
      < xs:enumeration value = "FOR_OFFICIAL_USE_ONLY" />
      < xs:enumeration value = "PROTECTED" />
      < xs:enumeration value = "PROTECTED_A" />
      < xs:enumeration value = "PROTECTED_B" />
      < xs:enumeration value = "PROTECTED_C" />
      < xs:enumeration value = "CONFIDENTIAL" />
      < xs:enumeration value = "EU_CONFIDENTIAL" />
      < xs:enumeration value = "WEU_CONFIDENTIAL" />
      < xs:enumeration value = "SECRET" />
      < xs:enumeration value = "SECRET_NATIONAL_SECURITY_INFORMATION" />
      < xs:enumeration value = "SECRET_FORMERLY_RESTRICTED_DATA" />
      < xs:enumeration value = "SECRET_RESTRICTED_DATA" />
      < xs:enumeration value = "SECRET" />
      < xs:enumeration value = "EU_SECRET" />
      < xs:enumeration value = "WEU_SECRET" />
      < xs:enumeration value = "TOP_SECRET_NATIONAL_SECURITY_INFORMATION" />
      < xs:enumeration value = "TOP_SECRET_FORMERLY_RESTRICTED_DATA" />
      < xs:enumeration value = "TOP_SECRET_RESTRICTED_DATA" />
      < xs:enumeration value = "EU_TOP_SECRET" />
      < xs:enumeration value = "FOCAL_TOP_SECRET" />
      < xs:enumeration value = "COMPANY_CONFIDENTIAL" />
      < xs:enumeration value = "OFFICIAL_USE_ONLY" />
      < xs:enumeration value = "TRADE_SECRET" />
      < xs:enumeration value = "TRADEMARK" />
      < xs:enumeration value = "REGISTERED_TRADEMARK" />
  ...
  <xs:complexType name = "SecurityClassificationType" >
    < xs:annotation>
      <xs:documentation>
        The SecurityClassificationType defines a security classification.
      </xs:documentation>
    </xs:annotation>
    <xs:choice>
      <xs:element name = "SecurityClassificationEnum"
        type= "SecurityClassificationEnumType" >
        < xs:annotation>
          <xs:documentation>
            The SecurityClassificationEnum element describes an often-used
            security classification.
          </xs:documentation>
        </xs:annotation>
      </xs:element>
      <xs:element name = "OtherSecurityClassification"
        type= "xs:string" >
        < xs:annotation>
          <xs:documentation>
            The OtherSecurityClassification element describes a security
  ...
  <xs:simpleType name = "DigitalModelFormatEnumType" >
    < xs:annotation>
      <xs:documentation>
        The DigitalModelFormatEnumType enumerates values that describe the
        format of a digital model.
      </xs:documentation>
    </xs:annotation>
    <xs:restriction base="xs:NMTOKEN">
      <xs:enumeration value = "STEPAP203" />
      < xs:enumeration value = "STEPAP203E2" />
      < xs:enumeration value = "STEPAP214" />
      < xs:enumeration value = "STEPAP242" />
      < xs:enumeration value = "JTOPEN" />
      < xs:enumeration value = "RPC" />
      < xs:enumeration value = "PDPMI" />
      < xs:enumeration value = "ACIS" />
      < xs:enumeration value = "PARASOLID" />
      < xs:enumeration value = "AUTODESK" />
  ...
  <xs:complexType name = "DigitalModelFormatType" >
    < xs:annotation>
      <xs:documentation>
        The DigitalModelFormatType defines the format of a digital model.
      </xs:documentation>
    </xs:annotation>
    <xs:choice>
      <xs:element name = "DigitalModelFormatEnum"
        type= "DigitalModelFormatEnumType" >
        < xs:annotation>
          <xs:documentation>
            The DigitalModelFormatEnum element describes an often-used
            format of a digital model.
          </xs:documentation>
        </xs:annotation>
      </xs:element>
      <xs:element name = "OtherDigitalModelFormat"
        type= "xs:string" >
        < xs:annotation>
          <xs:documentation>
            The OtherDigitalModelFormat element describes the format of a
            digital model in natural language.
          </xs:documentation>
        </xs:annotation>
      </xs:element>
    </xs:choice>
