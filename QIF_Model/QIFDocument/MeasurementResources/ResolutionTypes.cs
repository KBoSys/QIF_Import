...
namespace QIF_Model.QIFDocument.MeasurementResources
{
	...
	public class LinearResolutionType : ResolutionBaseType
	{
		...
		public Units.LinearValueType LinearValue { get; set; }	
	}
	...
	public class CartesianResolutionType : ResolutionBaseType
	{
		...
		public Units.LinearValueType CombinedCartesianResolution { get; set; }
	...
	public class XYZResolutionType
	{
		...
		[XmlElement(IsNullable = false)]
		public Units.LinearValueType XResolution { get; set; }

		/// <remarks The YResolution element is the resolution of the Y axis. />
		[XmlElement(IsNullable = false)]
		public Units.LinearValueType YResolution { get; set; }

		/// <remarks The ZResolution element is the resolution of the Z axis. />
		[XmlElement(IsNullable = false)]
		public Units.LinearValueType ZResolution { get; set; }
	}
	...
	public class CombinedSphericalResolutionType : ResolutionBaseType
	{
		...
		[XmlElement(IsNullable = true)]
		public Units.LinearValueType CombinedRadialResolution { get; set; }
		...
		[XmlElement(IsNullable = true)]
		public Units.AngularValueType CombinedAzimuthalResolution { get; set; }

		/// <remarks The CombinedPolarResolution element is the polar resolution of the device with a spherical coordinate system. />
		[XmlElement(IsNullable = true)]
		public Units.AngularValueType CombinedPolarResolution { get; set; }
	}
