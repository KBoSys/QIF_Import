...
namespace QIF_Model.QIFApplications.QIFProduct
{
    ...
    {
        /// <remarks The optional FolderIds element contains indices of sub-folders./>
        [XmlElement()]
        public QIFLibrary.Primitives.ArrayReferenceType FolderIds { get; set; }

        /// <remarks The optional FeatureNominalIds element contains feature nominals for the product definition./>
        [XmlElement()]
        ...
        /// <remarks The optional CharacteristicNominalIds element contains characteristic nominals for the product definition./>
        [XmlElement()]
        public QIFLibrary.Primitives.ArrayReferenceFullType CharacteristicNominalIds { get; set; }

        /// <remarks The optional NoteIds element contains notes for the product definition./>
        [XmlElement()]
        public QIFLibrary.Primitives.ArrayReferenceFullType NoteIds { get; set; }

        /// <remarks The optional PartNoteIds element contains part notes for the product definition./>
        [XmlElement()]
        public QIFLibrary.Primitives.ArrayReferenceFullType PartNoteIds { get; set; }

        /// <remarks The optional DatumDefinitionIds element contains datum definitions for the product definition./>
        [XmlElement()]
        public QIFLibrary.Primitives.ArrayReferenceFullType DatumDefinitionIds { get; set; }

        /// <remarks The optional DatumTargetDefinitionIds element contains datum target definitions for the product definition./>
        [XmlElement()]
        public QIFLibrary.Primitives.ArrayReferenceFullType DatumTargetDefinitionIds { get; set; }

        /// <remarks The optional DatumReferenceFrameIds element contains datum reference frames for the product definition./>
        [XmlElement()]
