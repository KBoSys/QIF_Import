...
namespace QIF_Model.QIFApplications.QIFProduct
{
    ...
    /// the file containing the CAD model and global parameters of the model.</remarks>
    ...
    public class ProductHeaderType : PartAssemblyHeaderType
    {
        ...
        /// value by the ScaleCoefficient.</remarks>
        [XmlElement]
        ...
        /// coordinates, in the global units defined above, that shall be considered as distinct.</remarks>
        [XmlElement]
        ...
        /// used for calculation of the mass properties of model entities.</remarks>
        [XmlElement]
