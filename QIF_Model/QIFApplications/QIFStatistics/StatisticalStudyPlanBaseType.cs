...
{
    /// <remarks The StatisticalStudyPlanBaseType is the abstract base type that defines information common to all statistical study plans./>
    ...
    {
        /// <remarks The optional Version element gives version information about the statistical study./>
        ...
        /// <remarks The FeatureItemIds element is the list of feature items to be included in this statistical study./>
        ...
        /// characteristic items to be included in this statistical study./>
        ...
        /// <remarks The optional Name element is the name identifying the statistical study./>
        [System.Xml.Serialization.XmlElementAttribute(DataType = "token")]
        public string Name { get; set; }

        /// <remarks The optional Description element is a description of the statistical study./>
        public string Description { get; set; }

        /// <remarks The optional PlanId element is the QIF id of the associated measurement plan./>
        public QIFReferenceType PlanId { get; set; }

        /// <remarks This optional compositor provides a choice between software, or a standard of specification./>
        ...
        /// <remarks The optional CorrectiveActionPlanId element is the QIF id of a corrective action plan./>
