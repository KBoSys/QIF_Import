...
namespace QIF_Model.QIFApplications.QIFStatistics
{
    ...
    public partial class ProcessDifferenceStudyPlanType : StatisticalStudyPlanBaseType
    {
        ...
        /// (absolute and relative) used to determine maximum allowed differences./>
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(Namespace = "http://qifstandards.org/xsd/qif3")]
    public partial class AbsoluteLimitsByUnitType
    {
        /// <remarks The optional LinearLimit element defines the limit that a linear characteristic must achieve./>
        public LinearValueType LinearLimit { get; set; }

        /// <remarks The optional AngularLimit element defines the limit that an angular characteristic must achieve./>
        public AngularValueType AngularLimit { get; set; }

        /// <remarks The optional AreaLimit element defines the limit that an area characteristic must achieve./>
        public AreaValueType AreaLimit { get; set; }

        /// <remarks The optional ForceLimit element defines the limit that a force characteristic must achieve./>
        public ForceValueType ForceLimit { get; set; }

        /// <remarks The optional MassLimit element defines the limit that a mass characteristic must achieve./>
        public MassValueType MassLimit { get; set; }

        /// <remarks The optional PressureLimit element defines the limit that a pressure characteristic must achieve./>
        public PressureValueType PressureLimit { get; set; }

        /// <remarks The optional SpeedLimit element defines the limit that a speed characteristic must achieve./>
        public SpeedValueType SpeedLimit { get; set; }

        /// <remarks The optional TemperatureLimit element defines the limit that a temperature characteristic must achieve./>
        public TemperatureValueType TemperatureLimit { get; set; }

        /// <remarks The optional TimeLimit element defines the limit that a time characteristic must achieve./>
        ...
        /// units, or units of temperature, area, force, mass, pressure, speed, or time./>
        [System.Xml.Serialization.XmlElementAttribute("UserDefinedUnitLimit")]
        public UserDefinedUnitValueType[] Limits { get; set; }

        /// <remarks The required n attribute is the number of absolute limits defined in the list./>
        [System.Xml.Serialization.XmlAttributeAttribute("n")]
        public uint Count
        {
            get => (uint)this.Limits.Length;
            set { }
        }
    }
}
