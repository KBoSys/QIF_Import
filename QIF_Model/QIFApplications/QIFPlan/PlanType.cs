...
namespace QIF_Model.QIFApplications.QIFPlan
{
    ...
    {
        /// <remarks> The optional Version element gives version information about the measurement plan.</remarks>
        [XmlElement()]
        ...
        /// both(in which case the two sets of rules must be identical).</remarks>
        [XmlElement()]
        ...
        /// or in a separate QIFDocument, or both(in which case the two sets of rules must be identical).</remarks>
        [XmlElement()]
        ...
        /// necessary for executing the Plan.</remarks>
        [XmlElement()]
        ...
        /// <remarks> The optional Measurands element captures any measurands used in the Plan.</remarks>
        [XmlElement()]
        public MeasurandsType Measurands { get; set; }

        /// <remarks> The optional LocalVariables element declares local variables and sets their initial values.</remarks>
        [XmlElement()]
        ...
        /// plan tree of PlanElements. All PlanElement instances occur within the tree.</remarks>
    ...
    /// plan element types.Plan elements are of two types: actions and action groups.</remarks>
    ...
    {
        /// <remarks> The optional WorkInstructionIds element gives the QIF ids of work instructions required to execute the plan element.</remarks>
    ...
    /// <remarks> The VariableSetType represents the setting of a variable.</remarks>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("xsd", "4.0.30319.1")]
    [System.SerializableAttribute()]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
