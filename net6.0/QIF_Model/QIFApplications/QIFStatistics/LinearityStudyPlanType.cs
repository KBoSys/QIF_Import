...
namespace QIF_Model.QIFApplications.QIFStatistics
{
    ...
    /// measured to determine the linearity of a measurement system.</remarks>
    ...
    public partial class LinearityStudyPlanType : StatisticalStudyPlanBaseType
    {
        ...
        /// the ids of one or more measurement devices in the measurement system to be studied.</remarks>
        public ArrayReferenceType? MeasurementDeviceIds { get; set; }

        /// <remarks> The optional GoodnessOfFitThreshold element is the minimum
        /// goodness of fit(R-squared) that must be achieved for the measurement device to pass.</remarks>
        ...
        /// (absolute and relative) used to determine minimum allowed linearity.</remarks>
