...
namespace QIF_Model.QIFApplications.MeasurementResources
{
    ...
    {
        /// <remarks> The Name element is the name of the measurement resource. </remarks>
        [XmlElement]
        public string? Name { get; set; }

        /// <remarks> The optional Description element is a description of the measurement resource. </remarks>
        [XmlElement]
        public string? Description { get; set; }

        /// <remarks> The optional Manufacturer element is the manufacturer of the measurement resource. </remarks>
        [XmlElement]
        ...
        /// they should all be identical (or nearly so).</remarks>
        [XmlElement]
        ...
        /// measurement resources in a QIF application instance file. </remarks>
        [XmlElement]
        ...
        /// measurement device.This element is in an optional choice. </remarks>
        [XmlElement]
        ...
        /// array, or XML structured). </remarks>
        [XmlElement]
