...
namespace QIF_Model.QIFLibrary.Geometry
{
    ...
    public class Curve12SetType : ListBaseType<Curve12BaseType>
    {
        ...
        public List<Curve12BaseType> Items { get => base.itemsField; set => base.itemsField = value; }
    }

    /// <remarks> The Curve13SetType represents a container for storing all 3D curves present in the CAD scene.</remarks>
    public class Curve13SetType : ListBaseType<Curve13BaseType>
    {
        ...
        public List<Curve13BaseType> Items { get => base.itemsField; set => base.itemsField = value; }
    }
}
