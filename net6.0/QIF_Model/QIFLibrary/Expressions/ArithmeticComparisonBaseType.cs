...
namespace QIF_Model.QIFLibrary.Expressions
{
    ...
    /// arithmetic comparisons must include the arithmetic constant, ComparisonTiny.</remarks>
    ...
    {
        /// <remarks> Each ArithmeticExpression element is one two arithmetic expressions to be compared.</remarks>
