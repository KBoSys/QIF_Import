...
namespace QIF_Model.QIFLibrary.Features.FeatureDefinitions
{
    ...
    {
        /// <remarks></remarks>
        public VectorType? AlongRowDirection { get; set; }

        /// <remarks></remarks>
        public LinearValueType? IncrementalRowDistance { get; set; }

        /// <remarks></remarks>
        public VectorType? BetweenRowDirection { get; set; }

        /// <remarks></remarks>
        public LinearValueType? RowSeparationDistance { get; set; }

        /// <remarks></remarks>
        public UnitVectorType? FeatureDirection { get; set; }

        /// <remarks></remarks>
        public uint NumberOfFeaturesPerRow { get; set; }
