...
namespace QIF_Model.QIFLibrary.Features.FeatureDefinitions
{
    ...
    /// must lie equally spaced on the line.</remarks>
    ...
    {
        /// <remarks> The LineDirection element is the direction of the line of features in the current coordinate system.</remarks>
        public UnitVectorType? LineDirection { get; set; }

        /// <remarks> The IncrementalDistance is the distance between adjacent features in the pattern.</remarks>
        public LinearValueType? IncrementalDistance { get; set; }

        /// <remarks> The optional FeatureDirection element is a direction
        /// characterizing the features in the pattern, for example, the axis of a cylinder or the direction of an extrusion.</remarks>
