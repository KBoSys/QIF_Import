...
namespace QIF_Model.QIFLibrary.Features.Nominals
{
    ...
    /// parallel planes feature nominal information for an individual opposite parallel planes feature.</remarks>
    ...
    public partial class OppositeParallelPlanesFeatureNominalType : SurfaceFeatureNominalBaseType
    {
        ...
        /// and against the length vector.</remarks>
        public PlaneType? CenterPlane { get; set; }

        /// <remarks> The optional LengthVector element is the nominal unit vector of the long axis of the feature.</remarks>
        ...
        /// the normal to the center plane.</remarks>
        ...
        /// provides details of the construction method.</remarks>
