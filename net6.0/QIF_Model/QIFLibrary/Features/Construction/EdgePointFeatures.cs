...
{
    /// <remarks> The EdgePointCopyType defines a copied edge-point construction.</remarks>
    ...
    /// casting of another feature type to an edge-point.The location is copied from the base feature.</remarks>
    ...
    /// or actual coordinate system.</remarks>
    ...
    /// retrieval of an edge-point from a scanned surface feature(point	cloud).</remarks>
    public class EdgePointFromScanType : ConstructionMethodBaseType
    {
        ...
        /// axis passes through the feature's location point adjusted by the Depth element.</remarks>
        [XmlElement]
        public Units.LinearValueType? SearchRadius { get; set; }

        /// <remarks> The PatchRadius element is the radius around the edge-point reference used to adjust location and orientation.</remarks>
        [XmlElement]
        public Units.LinearValueType? PatchRadius { get; set; }

        /// <remarks> The Distance element is the distance from the surface's edge where measurements to adjust orientation and location are taken.</remarks>
        [XmlElement]
        public Units.LinearValueType? Distance { get; set; }

        /// <remarks> The Depth element is the measuring depth at which the edge point is to be retrieved.</remarks>
        [XmlElement]
        public Units.LinearValueType? Depth { get; set; }

        /// <remarks> The RetrievalMethod element is the method used for retrieving the edge point from the acceptance cylinder.</remarks>
        [XmlElement]
        public IntermediatesPMI.RetrievalMethodEnumType RetrievalMethod { get; set; }
    }

    /// <remarks> The EdgePointConstructionMethodType defines the method for	constructing a unique nominal or measured edge-point feature.</remarks>
    public class EdgePointConstructionMethodType
    {
        #region Choice
        /// <remarks> This optional compositor provides a choice of the construction method for the edge point.</remarks>
